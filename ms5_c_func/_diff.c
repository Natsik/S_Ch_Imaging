/* Generated by Cython 0.20.1 on Sun Mar 23 21:37:32 2014 */
...
static PyObject *__pyx_pf_3MS5_c_diff_images_func(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_in_array1, PyArrayObject *__pyx_v_in_array2, PyObject *__pyx_v_channel_strides, PyObject *__pyx_v_h, PyArrayObject *__pyx_v_out_array); /* proto */
...
static char __pyx_k_F_prog_8_sem_GITHUB_DEPOT_S_Ch_I[] = "F:\\prog_8_sem\\GITHUB_DEPOT\\S_Ch_Imaging\\ms5_c_func\\_diff.pyx";
...
static PyObject *__pyx_pw_3MS5_1c_diff_images_func(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_in_array1,&__pyx_n_s_in_array2,&__pyx_n_s_channel_strides,&__pyx_n_s_h,&__pyx_n_s_out_array,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_out_array)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_h = values[3];
    __pyx_v_out_array = ((PyArrayObject *)values[4]);
  }
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_out_array), __pyx_ptype_5numpy_ndarray, 0, "out_array", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_3MS5_c_diff_images_func(__pyx_self, __pyx_v_in_array1, __pyx_v_in_array2, __pyx_v_channel_strides, __pyx_v_h, __pyx_v_out_array);
...
static PyObject *__pyx_pf_3MS5_c_diff_images_func(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_in_array1, PyArrayObject *__pyx_v_in_array2, PyObject *__pyx_v_channel_strides, PyObject *__pyx_v_h, PyArrayObject *__pyx_v_out_array) {
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_channel_strides); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_v_h); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *                 channel_strides, h,
 */
  __pyx_tuple__7 = PyTuple_Pack(5, __pyx_n_s_in_array1, __pyx_n_s_in_array2, __pyx_n_s_channel_strides, __pyx_n_s_h, __pyx_n_s_out_array); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(5, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_F_prog_8_sem_GITHUB_DEPOT_S_Ch_I, __pyx_n_s_c_diff_images_func, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
